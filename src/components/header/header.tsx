    ...
    <header className="px-10 pt-[58px] mb-[26px]">
      ...
      >
        ...
        <div className="flex items-center">
          ...
          >
            <button
              className={`pr-[7px] border-r-2 cursor-pointer ${i18n.language === "ua" ? "text-(--secondary)" : "text-(--gray)"}`}
              onClick={() => changeLang("ua")}
            >
              UA
            </button>
            <button
              className={`cursor-pointer ${i18n.language === "en" ? "text-(--secondary)" : "text-(--gray)"}`}
          ...
          <div className="flex gap-8">
            ...
            <div className="relative">
              ...
              <div
                ...
                absolute right-0 z-50 w-[178px] h-[137px] p-8 mt-2.5
